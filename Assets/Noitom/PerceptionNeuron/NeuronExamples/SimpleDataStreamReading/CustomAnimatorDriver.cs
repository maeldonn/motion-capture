...
public class CustomAnimatorDriver : MonoBehaviour
{
	...
	int									commandServerPort = 0;						// Axis command server port
	...
	void OnEnable()
	{
		...
		// Get first actor from source, if you didn't connected, there will be a nullpointer exception
	...
	void Update()
	{
		if( animator != null && source != null )
		{
            ...
            // instance a neuronAnimatorInstance first or there will be a null pointer exception
