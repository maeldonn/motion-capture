...
namespace Neuron
{
    public static class BoneLines
    {
        ...
        private static Material GetBoneLineMaterial(Color color, int render_queue_plus)
        {
            // create material
            ...
            if (shader == null)
                shader = UnityEditor.AssetDatabase.LoadAssetAtPath("Assets/NoitomNeuron/Neuron/Resources/Shaders/BoneLineShader.shader", typeof(Shader)) as Shader;
            if (shader != null)
            {
        ...
        private static NSH.OnAddBoneComponent<BoneLine> delegate_add_bone_line = new NSH.OnAddBoneComponent<BoneLine>(AddBoneLine);

        private static void AddBoneLine(HumanBodyBones bone, BoneLine bone_line, params object[] args)
        {
        ...
        private static NSH.OnAddBoneComponentTransform<BoneLine> delegate_add_bone_line_transform = new NSH.OnAddBoneComponentTransform<BoneLine>(AddBoneLineTransform);

        private static void AddBoneLineTransform(NeuronBones bone, BoneLine bone_line, params object[] args)
        {
        ...
        private static void RemoveBoneLine(HumanBodyBones bone, BoneLine bone_line, params object[] args)
        {
        ...
        private static void RemoveBoneLineTransform(NeuronBones bone, BoneLine bone_line, params object[] args)
        {
            bone_line.RemoveRenderer();
        }
