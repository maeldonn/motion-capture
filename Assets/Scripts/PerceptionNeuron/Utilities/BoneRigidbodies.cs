...
namespace Neuron
{
    public static class BoneRigidbodies
    {
        ...
        private static NSH.OnAddBoneComponent<Rigidbody> delegate_add_rigidbody = new NSH.OnAddBoneComponent<Rigidbody>(AddRigidBody);

        private static void AddRigidBody(HumanBodyBones bone, Rigidbody rigidbody, object[] args)
        {
        ...
        private static NSH.OnAddBoneComponentTransform<Rigidbody> delegate_add_rigidbody_transform = new NSH.OnAddBoneComponentTransform<Rigidbody>(AddRigidBodyTransform);

        private static void AddRigidBodyTransform(NeuronBones bone, Rigidbody rigidbody, object[] args)
        {
            rigidbody.useGravity = false;
            rigidbody.isKinematic = true;
        }
