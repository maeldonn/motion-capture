...
namespace Neuron
{
    ...
    public class NeuronActor
    {
        ...
        private static float NeuronUnityLinearScale = 0.01f;

        private BvhDataHeader header;
        private float[] data = new float[MaxFrameDataLength];
        private List<NoFrameDataDelegate> noFrameDataCallbacks = new List<NoFrameDataDelegate>();
        private List<ResumeFrameDataDelegate> resumeFrameDataCallbacks = new List<ResumeFrameDataDelegate>();
