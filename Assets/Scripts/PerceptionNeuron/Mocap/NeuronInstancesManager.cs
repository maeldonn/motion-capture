...
public class NeuronInstancesManager : MonoBehaviour
{
    ...
    private List<NeuronSource> sources = new List<NeuronSource>();
    private List<NeuronActor> actorsToInstantiate = new List<NeuronActor>();
    private List<NeuronAnimatorInstance> instancesToDestroy = new List<NeuronAnimatorInstance>();

    private Dictionary<NeuronActor, NeuronAnimatorInstance> instances = new Dictionary<NeuronActor, NeuronAnimatorInstance>();
    private List<NeuronAnimatorInstance> reservedInstances = new List<NeuronAnimatorInstance>();
    ...
    private void OnResumeActor(NeuronActor actor)
    {
        actorsToInstantiate.Add(actor);
    }

    private void OnSuspendActor(NeuronActor actor)
    {
    ...
    private bool SpawnInstance(NeuronActor actor)
    {
    ...
    private void KillInstance(NeuronAnimatorInstance instance)
    {
