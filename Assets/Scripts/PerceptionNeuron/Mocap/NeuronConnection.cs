...
namespace Neuron
{
    public static class NeuronConnection
    {
        ...
        private static Dictionary<Guid, NeuronSource> connections = new Dictionary<Guid, NeuronSource>();
        private static Dictionary<IntPtr, NeuronSource> socketReferencesIndex = new Dictionary<IntPtr, NeuronSource>();
        private static Dictionary<IntPtr, NeuronSource> commandSocketReferenceIndex = new Dictionary<IntPtr, NeuronSource>();
        ...
        private static NeuronSource CreateConnection(string address, int port, int commandServerPort, SocketType socketType)
        {
        ...
        private static void DestroyConnection(NeuronSource source)
        {
            if (source != null)
            {
        ...
        private static void UnregisterReaderCallbacks()
        {
        ...
        private static void OnFrameDataReceived(IntPtr customObject, IntPtr socketReference, IntPtr header, IntPtr data)
        {
        ...
        private static void OnSocketStatusChanged(IntPtr customObject, IntPtr socketReference, SocketStatus status, string msg)
        {
            NeuronSource source = FindSource(socketReference);
            if (source != null)
            {
        ...
        private static NeuronSource FindConnection(string address, int port, SocketType socketType)
        {
            NeuronSource source = null;
            foreach (KeyValuePair<Guid, NeuronSource> it in connections)
            {
        ...
        private static NeuronSource FindSource(IntPtr socketReference)
        {
            NeuronSource source = null;
        ...
        private static NeuronSource FindCommandSource(IntPtr commandSocketReference)
        {
            NeuronSource source = null;
