...
namespace Neuron
{
    public class TranceTransformsInstance : NeuronInstance
    {
        ...
        private Vector3[] bonePositionOffsets = new Vector3[(int)InertialBones.NumOfBones];
        private Vector3[] boneRotationOffsets = new Vector3[(int)InertialBones.NumOfBones];
...
#pragma warning disable 0414
        private bool usingHumanRig = true;
#pragma warning restore 0414
        ...
        private void FindTrackingSource()
        {
        ...
        #endregion just copy from trance sdk
        ...
        private static void SetPosition(Transform[] transforms, InertialBones bone, Vector3 pos)
        {
        ...
        private static void SetRotation(Transform[] transforms, InertialBones bone, Vector3 rotation)
        {
            Transform t = transforms[(int)bone];
            if (t != null)
            {
