...
namespace Neuron
{
    public class NeuronSource
    {
        ...
        private List<ResumeActorDelegate> resumeActorCallbacks = new List<ResumeActorDelegate>();
        private List<SuspendActorDelegate> suspendActorCallbacks = new List<SuspendActorDelegate>();
        private Dictionary<int, NeuronActor> activeActors = new Dictionary<int, NeuronActor>();
        private Dictionary<int, NeuronActor> suspendedActors = new Dictionary<int, NeuronActor>();
        private object suspendListLock = new object();
        private object actorCreateDestroyLock = new object();
        ...
        private void DestroyActor(int actorID)
        {
            lock (actorCreateDestroyLock)
            {
        ...
        private NeuronActor FindActiveActor(int actorID)
        {
            NeuronActor actor = null;
