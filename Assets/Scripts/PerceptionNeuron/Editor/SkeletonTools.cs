...
public class SkeletonTools : EditorWindow
{
    ...
    private string default_prefix = "Robot_";

    // gui
    private Vector2 scroll_position = new Vector2(0.0f, 0.0f);

    // collider
    private string collider_template_path = "Assets/Neuron/Prefabs/Robot Colliders Template.prefab";

    private string collider_template_path2 = "Assets/NoitomNeuron/Neuron/Prefabs/Robot Colliders Template.prefab";
    private Color bone_collider_color = Color.yellow;
    private int bone_collider_layer = 0;
    private string default_layer_name = "Body";

    // bone line
    private Color bone_line_color = Color.blue;

    private float bone_line_parent_width = 0.03f;
    private float bone_line_child_width = 0.008f;
    private int bone_line_render_order = 10;
